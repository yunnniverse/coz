...
if __name__ == '__main__':
  ...
  dataset_root = Path(__file__).resolve().parent.parent / 'datasets' / 'social-graph' / args.graph
  with open(dataset_root / f'{args.graph}.nodes', 'r') as f:
    nodes = getNumNodes(f)
  with open(dataset_root / f'{args.graph}.edges', 'r') as f:
    edges = getEdges(f)
